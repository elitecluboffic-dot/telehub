  ...
  <table class="simple">
    ...
    <?php foreach ($articles as $a): ?>
      <tr>
        ...
        <td><?= clean($a['author_name']) ?></td>
        <td><span class="type-badge" style="background:#6c757d"><?= clean($a['category']) ?></span></td>
    ...
    <?php if (empty($articles)): ?>
      <tr><td colspan="6" style="color:var(--text-dim)">Tidak ada artikel.</td></tr>
    <?php endif; ?>
  </table>
</div>
