...
<div class="dash-card" style="margin-top:16px">
  <div class="table-responsive">
    <table class="simple">
      <tr>
        <th>Judul</th><th>Penulis</th><th>Kategori</th><th>Tanggal</th><th>Views</th><th>Status</th><th>Aksi</th>
      </tr>
      <?php foreach ($articles as $a): ?>
        <tr>
          ...
          <td style="white-space:nowrap">
            👁️ <?= number_format($a['views'] ?? 0) ?>
            <br><small style="color:var(--text-dim)">🤖 <?= number_format($a['bot_views'] ?? 0) ?> bot</small>
          </td>
      ...
      <?php if (empty($articles)): ?>
        <tr><td colspan="7" style="color:var(--text-dim);padding:20px">Tidak ada artikel.</td></tr>
      <?php endif; ?>
    </table>
  </div>
</div>
